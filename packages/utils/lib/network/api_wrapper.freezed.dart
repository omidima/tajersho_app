...
/// @nodoc
class _$ApiWrapperTearOff {
  const _$ApiWrapperTearOff();
...
/// @nodoc
const $ApiWrapper = _$ApiWrapperTearOff();

/// @nodoc
mixin _$ApiWrapper<T> {
  @optionalTypeArgs
...
/// @nodoc
abstract class $ApiWrapperCopyWith<T, $Res> {
  factory $ApiWrapperCopyWith(
          ApiWrapper<T> value, $Res Function(ApiWrapper<T>) then) =
      _$ApiWrapperCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$ApiWrapperCopyWithImpl<T, $Res>
    implements $ApiWrapperCopyWith<T, $Res> {
  _$ApiWrapperCopyWithImpl(this._value, this._then);

  final ApiWrapper<T> _value;
  // ignore: unused_field
  final $Res Function(ApiWrapper<T>) _then;
}
...
/// @nodoc
class _$SuccessCopyWithImpl<T, $Res> extends _$ApiWrapperCopyWithImpl<T, $Res>
...
class _$Success<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'ApiWrapper<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements ApiWrapper<T> {
...
/// @nodoc
class _$FailureCopyWithImpl<T, $Res> extends _$ApiWrapperCopyWithImpl<T, $Res>
...
class _$Failure<T> implements Failure<T> {
  ...
  @override
  String toString() {
    return 'ApiWrapper<$T>.failure(error: $error)';
  }
...
abstract class Failure<T> implements ApiWrapper<T> {
