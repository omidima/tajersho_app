...
/// @nodoc
class _$StateWrapperTearOff {
  const _$StateWrapperTearOff();
...
/// @nodoc
const $StateWrapper = _$StateWrapperTearOff();

/// @nodoc
mixin _$StateWrapper<T> {
  @optionalTypeArgs
...
/// @nodoc
abstract class $StateWrapperCopyWith<T, $Res> {
  factory $StateWrapperCopyWith(
          StateWrapper<T> value, $Res Function(StateWrapper<T>) then) =
      _$StateWrapperCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$StateWrapperCopyWithImpl<T, $Res>
    implements $StateWrapperCopyWith<T, $Res> {
  _$StateWrapperCopyWithImpl(this._value, this._then);

  final StateWrapper<T> _value;
  // ignore: unused_field
  final $Res Function(StateWrapper<T>) _then;
}
...
/// @nodoc
class _$IdleCopyWithImpl<T, $Res> extends _$StateWrapperCopyWithImpl<T, $Res>
...
abstract class Idle<T> implements StateWrapper<T> {
...
/// @nodoc
class _$LoadingCopyWithImpl<T, $Res> extends _$StateWrapperCopyWithImpl<T, $Res>
...
abstract class Loading<T> implements StateWrapper<T> {
...
/// @nodoc
class _$DataCopyWithImpl<T, $Res> extends _$StateWrapperCopyWithImpl<T, $Res>
...
class _$Data<T> implements Data<T> {
  ...
  @override
  String toString() {
    return 'StateWrapper<$T>.data(data: $data)';
  }
...
abstract class Data<T> implements StateWrapper<T> {
...
/// @nodoc
class _$ErrorCopyWithImpl<T, $Res> extends _$StateWrapperCopyWithImpl<T, $Res>
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'StateWrapper<$T>.error(error: $error)';
  }
...
abstract class Error<T> implements StateWrapper<T> {
